...
public class BasePlusCommissionEmployee extends EmployeeMain{
    ...
    public String toString() {
       double salary = this.computeSalary(); 
        return "empID = " + getEmpID() + ", empName = " + getEmpName() + ", empDateHired = " + getEmpDateHired() + ", empBirthDate = " + getEmpBirthDate() + ", totalSales = " + totalSales + ", baseSalary =  " + baseSalary + ", salary = " + salary;
    }
